...
class Escena2 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('espacio', '/img/Espacio.png');
        this.load.image('red', '/img/red.png');
        this.load.spritesheet('nave', '/img/nave.png', { frameWidth: 70, frameHeight: 62 });
        this.load.image('enemy', '/img/Enemigo2.png');
        this.load.image('disparos', '/img/shoot.png');
        this.load.image('power', '/img/powerUp.png');  
    }
    ...
    create() {
        ...
        this.activatePower = false; //variable booleana que es un activador del powerUp, al inicio esta en falso
        ...
        this.power.setCollideWorldBounds(true);// // collision del power con los limites del juego
